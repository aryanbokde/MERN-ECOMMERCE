...
const NewProduct = () => {
  ...
  const createProductHandler = async(e) => {
    ...
    e.preventDefault();
    const data = {
      name, price, description:desc, images, category, stock, 
    }    
            ...
            <h2>Add New Product</h2>
              <div className='row'>
                <div className="col-md-6">           
                    <form className="" encType="multipart/form-data" onSubmit={createProductHandler}>
                          <div className="form-group mb-3">
                            <input className="form-control" type="text" placeholder="Product Name" required name="name" onChange={(e) => setName(e.target.value)} />
                          </div>
                          <div className="form-group mb-3">
                            <input className="form-control" type="number" placeholder="Product Price" required name="price"  onChange={(e) => setPrice(e.target.value)} />
                          </div>
                          <div className="form-group mb-3">
                            <textarea placeholder='Product Description' required name='desc' onChange={(e) => setDesc(e.target.value)} className="form-control"/>
                          </div>
                          <div className="form-group mb-3">
                          ...
                          <div className="form-group mb-3">
                            <input className="form-control" type="number" placeholder="Stock" required name="stock" value={stock} onChange={(e) => setStock(e.target.value)} />
                          </div>
                          <div className="form-group mb-3 img-div">
                            <input className="form-control" type="file" required name="avatar" accept='image/*' onChange={createProductImageChange} multiple/>
                          </div>
